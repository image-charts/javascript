declare module "node-image-charts" {
  export default class ImageCharts {
    ...
    * 
    * @param value - data format with custom scaling
    */
    ...
    * 
    * @param value - QRCode data encoding
    */
    ...
    * @default "L|4"
    * @param value - QRCode error correction level and optional margin
    */
    ...
    * @default ".png"
    * @param value - Output fake format
    */
    ...
    * 
    * @param value - Chart size (&lt;width&gt;x&lt;height&gt;)
    */
    ...
    * 
    * @param value - Text for each series, to display in the legend
    */
    ...
    * @default "000000"
    * @param value - Chart legend text and style
    */
    ...
    * 
    * @param value - Solid or dotted grid lines
    */
    ...
    * 
    * @param value - chart title colors and font size
    */
    ...
    * 
    * @param value - Display values on your axis lines or change which axes are shown
    */
    ...
    * 
    * @param value - Custom string axis labels on any axis
    */
    ...
    * 
    * @param value - Font size, color for axis labels, both custom labels and default label values
    */
    ...
    * 
    * @param value - compound charts and line fills
    */
    ...
    * 
    * @param value - line thickness and solid/dashed style
    */
    ...
    * label1|label2");
    * 
    * @param value - bar, pie slice, doughnut slice and polar slice chart labels
    */
    ...
    * [Reference documentation]{@link https://documentation.image-charts.com/reference/legend-text-and-style/}
    * @default "r"
    * @param value - Position of the legend and order of the legend entries
    */
    ...
    * 
    * @param value - doughnut chart inside label
    */
    ...
    * 
    * @param value - image-charts enterprise `account_id`
    */
    ...
    * 
    * @param value - HMAC-SHA256 signature required to activate paid features
    */
    ...
    * 
    * @param value - Default font family for all text from Google Fonts. Use same syntax as Google Font CSS API
    */
    ...
    * 
    * @param value - Default font style for all text
    */
    ...
    * 
    * @param value - localization (ISO 639-1)
    */
